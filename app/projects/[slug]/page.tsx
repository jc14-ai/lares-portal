...
export default async function Page({params}: {params: Promise<{slug: string}>}) {
    ...
    const project = decodeURIComponent(resolvedParams.slug).replace(/-/g, ' ').toUpperCase();
    return (
        <section className="flex flex-col items-center bg-white min-h-screen w-screen h-fit pb-8">
            <NavBar/>
            <div className="flex flex-col justify-center p-4 rounded-xl border border-gray-100 shadow w-[90%] min-h-[120px] h-fit mb-4 gap-2 mt-25">
            ...
            <div className="flex gap-4 w-[90%] flex-col md:flex-row lg:flex-row">
                <div className="flex flex-col min-w-[70%] w-full">
                    ...
                    <div className="bg-white border border-gray-200 h-[600px] w-full rounded-xl shadow-sm relative overflow-hidden">
                        <iframe
