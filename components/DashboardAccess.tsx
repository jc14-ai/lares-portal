...
export default function DashboardAccess(){
    ...
    return (
        <div className="flex justify-between items-center p-4 rounded-xl border border-gray-100 shadow w-[90%] min-h-[120px] h-fit cursor-pointer hover:border-blue-500 duration-200 mb-4 group"
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
        onClick={() => router.push('/')}>
            <span className="flex items-center gap-2">
                <div className="md:flex lg:flex justify-center items-center bg-blue-100 rounded-full hidden md:h-[40px] md:w-[40px] lg:h-[60px] lg:w-[60px] group-hover:bg-blue-700 duration-200 p-2">
